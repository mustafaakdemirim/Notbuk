...
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/fire/firestore */ 7550);
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/fire/auth */ 6829);
...
let FirestoreService = class FirestoreService {
    ...
    notlariListele(user) {
        return this.firestore.doc('kullanicilar/' + user).collection('Notlar').snapshotChanges();
    }
    notOlustur(kayit, user) {
        return this.firestore.doc('kullanicilar/' + user).collection('Notlar').add(kayit);
    }
    // eslint-disable-next-line @typescript-eslint/naming-convention
